 ...
 */
final class Version20241225133837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "news" (id UUID NOT NULL, title VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, sentiment VARCHAR(255) DEFAULT NULL, source VARCHAR(255) DEFAULT NULL, image_url TEXT DEFAULT NULL, date VARCHAR(255) DEFAULT NULL, website_url TEXT DEFAULT NULL, language VARCHAR(255) NOT NULL, source_country VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5017171A5F37A13B ON personal_access_token (token)');
